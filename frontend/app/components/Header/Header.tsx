      ...
      <div className="hidden md:flex items-center space-x-4">
        <div className="flex space-x-2">
          {categories.map((categorie, index) => (
            <div key={index} className="bg-background font-medium text-foreground px-3 py-2 rounded text-sm transition-all duration-300 hover:bg-primaryDark hover:text-primaryDarkForeground hover:scale-105 cursor-pointer">
